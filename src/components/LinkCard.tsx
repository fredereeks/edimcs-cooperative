        ...
        return (
            <li className={`relative group`}>
                <div className={`relative flex items-center w-full cursor-pointer hover:bg-primary hover:text-slate-100 md:hover:text-slate-700 md:hover:bg-transparent`}>
                    ...
                    <FaCaretDown className={`group-hover:text-white md:group-hover:text-slate-700 relative z-50 p-1 text-[.86rem] cursor-pointer text-slate-600 mt-1 -mx-2`} size={20} onClick={() => setDropdown(true)} />
                </div>
