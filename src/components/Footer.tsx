...
export default function Footer() {
  return (
    <footer className="py-10 px-4 flex flex-col relative after-overlay after:bg-slate-900/95">
      ...
      <div className="container mx-auto py-4 grid sm:grid-cols-3 md:grid-cols-3 gap-4 relative z-20">
        {footerLinks.slice(0,3).map((footer,i) => (
          <aside key={footer.id} className={`flex flex-col gap-3 ${i === 0 ? 'col-span-3 md:col-span-1' : 'col-span-1 md:pl-5 md:ml-7'}`}>
