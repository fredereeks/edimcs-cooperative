    ...
    <main className="flex flex-col relative">
      <section  className="py-20 px-4 bg-white relative">
        <div className="container mx-auto flex flex-col gap-6 md:flex-row py-10 md:py-20">
          <aside data-aos-duration="4000" data-aos="zoom-in-up" className="relative flex-1 flex justify-end">
          ...
          <aside data-aos-duration="1000" data-aos="fade-up-right" className="py-10 md:py-20 flex flex-col gap-2 md:justify-between items-center">
            ...
            <p data-aos-duration="1000" data-aos-delay="3000"  data-aos="zoom-out-up" style={{ lineHeight: 1.9 }} className="text-slate-500 dark:text-slate-400 text-xs sm:text-sm leading-loose font-light max-w-md sm:max-w-lg">Whether you are looking for a short-term savings plan, a medium or long-term savings plan. Hell, if you are looking for a money pool, we got you covered on all sides.</p>
          </aside>
        </div>
        <div className="container mx-auto grid sm:grid-cols-2 md:grid-cols-3 gap-5 justify-center">
          {
            [
              ...
              <Link  data-aos-duration="1000" data-aos="fade-down-right" href={`/login`} key={id.toString()} className="flex flex-col text-slate-500 max-w-[20rem] mx-auto my-5 rounded-md overflow-hidden hover:shadow-lg transition-all">
                <span  data-aos-duration="1000" data-aos-delay="1000" data-aos="fade-down-right" className="min-h-[150px] sm:h-[150px] md:h-[170px] relative">{image}</span>
                <div data-aos-duration="4000" data-aos="fade-left" className="flex-1 flex flex-col justify-between gap-2 p-4">
                  <div className="flex-1 flex flex-col">
                    <h4 data-aos-duration="1000" data-aos-delay="2000" data-aos="fade-down-left" className="font-bold text-lg sm:text-xl text-red-500">{title}</h4>
