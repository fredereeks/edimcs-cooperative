...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col">
      <div className="relative py-20 px-4 bg-slate-600 after:bg-gradient-t-b after:from-slate-500 after:to-primary after-overlay">
          ...
          <div className="relative z-20 container mx-auto py-5 grid sm:grid-cols-2 md:grid-cols-3 text-white">
            {
              [
                ...
                <div key={id.toString()} className={`${i === 0 ? 'bg-zinc-800 sm:col-span-2 md:col-span-1' : i === 1 ? 'bg-zinc-800/80' : 'bg-zinc-800/10'} p-7 flex flex-col gap-2`}>
                ...
                [
                  ...
                  <div key={value.id} className="flex items-center gap-2">
                    <div className="flex flex-col gap-1 items-center w-[5rem] text-center">
                      <div className="border-2 border-red-500 text-slate-500 rounded-full grid place-items-center h-9 w-9 sm:h-10 sm:w-10">
                        {value.icon}
                      </div>
