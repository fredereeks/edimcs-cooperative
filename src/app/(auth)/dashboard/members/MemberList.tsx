...
export default function MemberList({ memberData }: { memberData: MemberProps[] }) {
    ...
    const [selectedMember, setSelectedMember] = useState<MemberProps>({ id: 492348, image: "", firstname: "string", middlename: "string", lastname: "string", email: "string", status: "string", phone: "string", type: "string", account_name: "string", account_number: 492348, banker: "string", memberId: 492348, date: "string", address: 'Sting wier', savings: 492348, investment: 492348, withdrawal: 492348, balance: 492348 })
